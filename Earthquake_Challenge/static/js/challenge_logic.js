...
// D3.1 Add a third map style as a tile layer
...
// Create a base layer that holds all three maps (D3.2)
let baseMaps = {
  "Streets": streets,
...
// D2.2 Add a reference to the major earthquake data to the overlay object.
let overlays = {
...
////--- begining of part 2 step 3 to 9
...
// violet 8a2be2 blue #0000ff bright pink #E033FF   originals >5 #ea2c2c  >4#ea822c else #98ee00
function getColor(magnitude) {
  if (magnitude > 5) {
    return "#ea2c2c";
  }
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  L.geoJson(data,{color:"#E033FF", weight:2})
